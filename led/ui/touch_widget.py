...
from kivy.graphics import Color, Point, GraphicException, Translate, Fbo, ClearColor, ClearBuffers, Scale
...
class TouchWidget(FloatLayout):
    ...
    def capture_image(self):
        if self.__is_update_needed is False:
            return None
        ...
        diff = end - start
        self.__logger.info(__name__ + " end - capture image time={0}".format(diff))
        self.__is_update_needed = False
        return image
